...
<head>
  ...
  <title>{{$TITLE??'Aplikasi Laporan Kegiatan'}}</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Kegiatan</span>
    </a>
  ...
  <footer class="main-footer">
    <strong>Copyright by J</a>.</strong>
    All rights reserved.
